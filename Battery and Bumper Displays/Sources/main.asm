...
_Startup:
            ...
            JSR    putsLCD   ;jump to subroutine putsLCD
...
lbl         MOVB   #$90,ATDCTL5       ;r.just., unsign., sing.conv., mult., ch0, start conv.
            ...
            LDAA   ATDDR4L   ; or4      ;load the ch4 result into AccA
            LDAB   #39                ;AccB = 39
            MUL                       ;AccD = 1st result x 39
            ADDD   #600               ;AccD = 1st result x 39 + 600
            
            JSR    int2BCD            ;jump into subroutine int2BCD            
            JSR    BCD2ASC            ;jump to subroutine   BCD2ASC 
            
            LDAA   #$8D                ;move LCD cursor to the 1st row, end of msg1
            JSR    cmd2LCD            ;jump to subroutine cmd2LCD
            
            LDAA   TEN_THOUS          ;output the TEN_THOUS ASCII character
            JSR    putcLCD            ;jump to subroutine puctLCD
            
            LDAA   THOUSANDS          ;output the THOUSANDS ASCII character
            JSR    putcLCD            ;jump to subroutine puctLCD
            
            LDAA   #'.'               ;ascii character for period
            JSR    putcLCD
...
initLCD     BSET  DDRB,%11111111 ; configure pins PS7,PS6,PS5,PS4 for output
            ...
            JSR   del_50us ; -"-
            LDAA #$38 ; set 4-bit data, 2-line display
            JSR cmd2LCD ; -"-
